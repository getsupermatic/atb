...
This Privacy Policy explains how At Beyond Limited (trading as At The Beyond — "we", "us", "our") collects, uses, stores, shares, and protects personal data when you visit atbeyond.com, contact us, engage us as clients or partners, or otherwise interact with us.
...
This Policy should be read together with our [Cookie Policy](/legal/cookies), [Website Terms and Conditions](/legal/terms), [AI Transparency Policy](/legal/ai-transparency), and [Responsible AI Policy](/legal/responsible-ai).
...
- Billing and payment details (account name, bank or card identifiers as required by our payment processors — At The Beyond does not store full card numbers)
...
- Sharing information about At The Beyond, our services, AI Blueprints, events, and insights where we have a lawful basis to do so
...
- Use client data to train At The Beyond, third-party, or public AI models without explicit, written agreement

## 5. AI and intelligent systems

At The Beyond is an AI-native company. We design, deploy, and operate AI systems for ourselves and for our clients. The way we handle personal data in AI contexts is summarised here and explained more fully in our AI Transparency Policy and Responsible AI Policy.
...
- Client data is not used to train At The Beyond, public, or third-party AI models without the client's explicit written agreement.
...
### At The Beyond's own products (FrontlineOS, CommerceOS, MarketingOS and other Blueprints)

- At The Beyond's products are deployed in dedicated, per-client environments under separate agreements; the public website does not host live product instances.
- Where At The Beyond is the controller for limited operational data (for example, account administration), we minimise the data we hold and apply security controls proportionate to the risk.
- Where At The Beyond is the processor, we act under the client's instructions as set out in the relevant DPA.
...
We may send you communications about At The Beyond's services, products, events, and insights where:
...
### Within the At The Beyond group

We may share personal data with current or future At The Beyond group companies for the purposes set out in this Policy and under appropriate intra-group terms.
...
At The Beyond is based in the United Kingdom but works with clients and providers in the UK, EU/EEA, the United States, and other regions. As a result, your personal data may be transferred to, stored in, or accessed from countries outside the UK or EEA.
...
Residents of California and certain other US states have additional rights under their state laws (for example, to know, delete, correct, and limit certain uses of personal information, and to opt out of "sale" or "sharing" — At The Beyond does not sell or share personal information for cross-context behavioural advertising as those terms are defined under the CCPA/CPRA).
...
- **Mark correspondence:** "Attention: Data Protection".
...
We may update this Policy from time to time. The latest version will always be available at atbeyond.com/legal/privacy. We will let you know about material changes through the website or, where appropriate, by email.
