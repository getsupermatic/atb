...
These Terms and Conditions ("Terms") govern your use of atbeyond.com (the "Website") operated by At Beyond Limited (trading as At The Beyond — "we", "us", "our").

By accessing or using the Website you agree to be bound by these Terms. If you do not agree, please do not use the Website.

Read these Terms alongside our [Privacy Policy](/legal/privacy), [Cookie Policy](/legal/cookies), [AI Transparency Policy](/legal/ai-transparency), and [Responsible AI Policy](/legal/responsible-ai).
...
At Beyond Limited is a UK-registered company (Company No. 17146628) with its registered office at 71-75 Shelton Street, Covent Garden, London, United Kingdom, WC2H 9JQ. We trade as "At The Beyond". We are an AI-native agency and technology partner, providing advisory services and AI Blueprints — including FrontlineOS, CommerceOS, and MarketingOS — together with related design, build, deployment, and operate services.

At this stage, the Website provides general information about At The Beyond, our approach, our Blueprints, and our services. It is for informational and marketing purposes only. The Website is not, of itself, a place to buy, configure, or use At The Beyond products — those are delivered to clients in dedicated environments under separate contracts.
...
Service descriptions on the Website — including descriptions of our AI Blueprints (for example, FrontlineOS, CommerceOS, MarketingOS), our engagement models (Subscribe & Deploy, Customise & Accelerate, Co-Innovate & Pioneer), and ATBOS — are indicative only. They do not constitute an offer, a binding commitment, or a guarantee of availability, performance, or outcome.
...
Nothing on the Website creates a partnership, agency, employment, fiduciary, or joint-venture relationship between you and At The Beyond.

## 6. Intellectual property

### 6.1 Our intellectual property

Unless otherwise stated, all content on the Website is owned by or licensed to At The Beyond, including, without limitation:
...
### 6.2 At The Beyond Blueprints, ATBOS, and proprietary frameworks

At The Beyond's proprietary intellectual property includes, without limitation:

- ATBOS — At The Beyond's AI-native operating system and the underlying AI agents, workflows, and orchestration patterns;
- AI Blueprints, including FrontlineOS, CommerceOS, and MarketingOS;
...
- At The Beyond retains ownership of its methodologies, frameworks, patterns, prompts, templates, agent designs, and generalised learnings, including any improvements, evolutions, and tooling developed during an engagement;
...
Client confidential information remains protected under the relevant engagement agreement and is not used to train At The Beyond or third-party public AI models without the client's explicit written agreement. All other rights are reserved.
...
- At The Beyond does not guarantee outcomes, accuracy, performance, fitness for purpose, availability, or compliance from AI concepts described on the Website;
...
**Liability cap:** Where liability cannot lawfully be excluded, our total aggregate liability arising out of or in connection with these Terms or your use of the Website is capped at the fees paid by the client to At The Beyond in the 6 months preceding the event giving rise to the claim.
...
You agree to indemnify and hold At The Beyond harmless against claims, losses, damages, liabilities, and reasonable costs (including legal fees) arising out of or in connection with:
